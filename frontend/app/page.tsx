  ...
  return (
    <div className="site">
      ...
      <main>
        ...
        <Container sectionClassName=" hero-section">
        ...
        <Container sectionClassName=" tabs-section">
        ...
        <Container id="how-it-works" sectionClassName="how-it-works">
        ...
        <Container id="pricing" sectionClassName="pricing-section">
        ...
        <Container id="workflow" sectionClassName="workflow">
        ...
        <Container id="testimonials" sectionClassName="testimonials">
        ...
        <Container id="team-insights" sectionClassName="insights">
